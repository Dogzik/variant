...
struct variant_alternative<I, variant<T0, Ts...>>
{
	static_assert(I < (sizeof...(Ts)+1), "Type index out of bound");
	typedef typename variant_alternative<I - 1, variant<Ts...>>::type type;
};
